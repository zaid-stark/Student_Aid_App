...
<body>
        ...
        <nav class="navbar navbar-expand-lg  navbar-light">
            ...
            <li class="dropdown">
              ...
              <div class="dropdown-menu">
                ...
                <a class="dropdown-item" href="todo-list.html">to-do list</a>
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-12 banner-right">
                    ...
                    <p class="mx-auto text-white  mt-20 mb-40">
                        You Can Add Your Events In Google Calendar. 
                    </p>
                    <div class="link-nav">
                        <span class="box">
  ...
  <h1 class="update_3">
    ...
    <form method="post" action="addEvent.php" class="form">
        ...
        <div class="form-group">
            <input type="submit" class="form-control btn-primary update_2" name="submit" value="Add Event"/>
        </div>
    </form>
</div>
</div>
